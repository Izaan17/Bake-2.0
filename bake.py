...
def add_command(args: argparse.Namespace, printer: CustomPrinter):
...
def edit_command(args: argparse.Namespace, printer: CustomPrinter):
    wrapper_path = os.path.join(constants.WRAPPER_SCRIPTS_FOLDER, args.name)
...
def delete_command(args: argparse.Namespace, printer: CustomPrinter):
    wrapper_path = os.path.join(constants.WRAPPER_SCRIPTS_FOLDER, args.name)
    symlink_path = os.path.join(constants.USER_BIN_DIR, args.name)
